		...
		<div class="col-md-4">
			<div class="panel no-bd bg-green">
				<div class="panel-heading clearfix pos-rel">
					...
					<h2 class="panel-title width-100p text-center w-500 f-20 carrois">To
						Do List</h2>
				...
				<div class="panel-body bg-green p-t-0 p-b-10">
					<div class="row">
						<div class="col-md-12">
							<div class="row m-b-10">
								<input class="form-control" id="new-todo"
									placeholder="What needs to be done?" type="text" class="span8" />
							</div>
							<div class="row" id="task-manager">
								<div class="task-actions clearfix">
									...
									<div class="pull-right">
										<a href="index.html#" class="create-task c-white p-r-10"><i
											class="fa fa-plus-circle"></i> Create Task</a> <a
											href="index.html#" class="delete-task c-white p-r-10"><i
											class="fa fa-minus-circle"></i> Delete All Tasks</a>
									</div>
								</div>
								<ul id="sortable-todo">
									<li
										class="sortable col-md-12 m-b-10 bd-3 bg-opacity-20 fade in">
										<a href="index.html#" class="pull-right c-white p-l-10"
										data-dismiss="alert"><i class="fa fa-times f-18"></i></a> <a
										href="index.html#" class="pull-right c-white"
										data-dismiss="alert"><i class="fa fa-pencil f-18"></i></a>
										<div class="sortable-item">
											<div class="pos-rel">
												<input tabindex="13" type="checkbox"
													class="pull-left task-item">
											</div>
									...
									<li
										class="sortable col-md-12 p-10 m-b-10 bd-3 bg-opacity-20 fade in">
										<a href="index.html#" class="pull-right c-white p-l-10"
										data-dismiss="alert"><i class="fa fa-times f-18"></i></a> <a
										href="index.html#" class="pull-right c-white"
										data-dismiss="alert"><i class="fa fa-pencil f-18"></i></a>
		...
		<div class="col-md-4">
			<div class="panel panel-default">
				<div class="panel-heading clearfix pos-rel">
					...
					<h2
						class="panel-title width-100p c-blue text-center w-500 f-20 carrois">Contact</h2>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="withScroll" data-height="320">
								<a href="index.html#" class="message-item media">
									<div class="media">
										<img src="assets/img/avatars/avatar1.png" alt="avatar 1"
											width="35" class="pull-left">
										<div class="media-body">
											...
											<div class="pull-right f-18 p-t-10">
												<i rel="tooltip" title="add to favs" data-placement="left"
													class="favs fa fa-star-o p-r-10"></i> <i rel="tooltip"
													title="send email" data-placement="left"
													class="fa fa-envelope-o p-r-10"></i> <i rel="tooltip"
													title="show phone" data-placement="left"
													class="fa fa-phone"></i>
											</div>
										</div>
									</div>
								</a> <a href="index.html#" class="message-item media">
									<div class="media">
										...
										<div class="media-body">
											...
											<div class="pull-right f-18 p-t-10">
												<i rel="tooltip" title="remove from favs"
													data-placement="left"
													class="favs fa fa-star p-r-10 c-orange"></i> <i
													rel="tooltip" title="send email" data-placement="left"
													class="fa fa-envelope-o p-r-10"></i> <i rel="tooltip"
													title="show phone" data-placement="left" title="show phone"
													class="fa fa-phone"></i>
											</div>
										</div>
									</div>
										...
										<div class="media-body">
											...
											<div class="pull-right f-18 p-t-10">
												<i rel="tooltip" title="add to favs" data-placement="left"
													...
													title="send email" data-placement="left"
													class="fa fa-envelope-o p-r-10"></i> <i rel="tooltip"
													title="show address" data-placement="left"
													class="fa fa-home"></i>
											</div>
										</div>
									</div>
		...
		<div class="col-lg-4 m-b-20">
			<div class="panel panel-default">
				<div class="panel-heading clearfix pos-rel">
					...
					<h2
						class="panel-title width-100p c-red text-center w-500 f-20 carrois">Email</h2>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="withScroll" data-height="480">
								<a href="index.html#" class="message-item media">
									<div class="media">
										<img src="assets/img/avatars/avatar13_big.png" alt="avatar 13"
									...
									<p class="f-14 c-gray">Lorem ipsum dolor sit amet, consectetuer
										adipiscing elit.</p>
								</a> <a href="index.html#" class="message-item media">
									<div class="media">
									...
									<p class="f-14 c-gray">Hello Steve, I have added new files in
										your Dropbox in order to show you how to...</p>
								</a> <a href="index.html#" class="message-item media">
									<div class="media">
										<img src="assets/img/avatars/avatar11_big.png" alt="avatar 11"
											width="50" class="pull-left">
										<div class="media-body">
											<small class="pull-right">23 Sept</small>
											<h5 class="c-dark">
									...
									<div class="media">
										<img src="assets/img/avatars/avatar10_big.png" alt="avatar 10"
											width="50" class="pull-left">
										<div class="media-body">
											<small class="pull-right">23 Sept</small>
											<h5 class="c-dark">
									...
									<div class="media">
										<img src="assets/img/avatars/avatar9_big.png" alt="avatar 9"
											width="50" class="pull-left">
										<div class="media-body">
											<small class="pull-right">23 Sept</small>
											<h5 class="c-dark">
									...
									<div class="media">
										<img src="assets/img/avatars/avatar8_big.png" alt="avatar 8"
											width="50" class="pull-left">
										<div class="media-body">
											<small class="pull-right">23 Sept</small>
											<h5 class="c-dark">
									...
									<div class="media">
										<img src="assets/img/avatars/avatar7_big.png" alt="avatar 7"
											width="50" class="pull-left">
										<div class="media-body">
											<small class="pull-right">23 Sept</small>
											<h5 class="c-dark">
