...
*/
	...
	*/
	'attributes' => array(
			...
			'country'				=> 'País',
			'pldr_phone' 			=> 'Ingresa tu teléfono',
			'pldr_cellphone' 		=> 'Ingresa tu celular',
			'pldr_street'			=> 'Ingresa tu dirección',
			'pldr_city'				=> 'Ingresa tu ciudad',
			'pldr_state'			=> 'Ingresa tu estado',
			'pldr_zipcode'			=> 'Ingresa tu codigo postal',
			'pldr_country'			=> 'Ingresa un pais',
				
	),
		
	'messages' => array(
			'account_created' 		=> 'Registro guardado correctamente',
			'account_fails' 		=> 'El registro no pudo ser guardado',
	),
